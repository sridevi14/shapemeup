...
<main className="page">
   ...
   <div className="container product_1">
         <center>
         <h3 className="m-5">Product Overview</h3>
...
With so many people realizing the importance of maintaining fitness and yet stuck at home with no access to fitness facilities, we at Honeycomb Technologies have come up with an application which solves the problem. We have created an unique application which enables anyone across the world to access the fitness coach of their choice, fitness program and diet program under the single umbrella. <br/><br/>

ShapeMeUp, as the name suggests, helps every client to get to their best shape and fitness by following the fitness program created specific for every client, flexible yet most effective diet plan crafted to suit the needs of every individual. <br/><br/>

ShapeMeUp helps both the fitness coach and fitness aspirants equally to stay on top of their goals. 
...
<center>
      ...
      <div className="row flex-column-reverse flex-sm-row biss_module ">
      <p className="col-lg-8 col-md-8 col-xl-8   ">The fitness app ShapeMeUp has several business modules to help both fitness coaches and fitness aspirants (clients). 
      </p>
     
<h4 className="col-4 col-md-4 col-xl-4  biss_text">Business Modules

</h4>

</div>

<div className="row k coach_module">
     
<h4 className="col-4 col-md-4 col-xl-4  coach_text">Coach Modules
</h4>
<p className="col-lg-8 col-md-8 col-xl-8 ">
...
ShapeMeUp is designed to cater to every fitness enthusiast and meet their specific needs. It is easily customizable to suit the fitness coaches across the globe to give effective training to their clients. 
   ...
   <div className="container">
         <center>
<div className="row  flex-column-reverse flex-sm-row client_module">
      <p className="col-lg-8 col-md-8 col-xl-8 mt-0">
Here we refer to the fitness aspirants as Clients. This is an individual or team that is being trained by the Coaches


</p>
<h4 className="col-4 col-md-4 col-xl-4 mt-0">Client Modules
